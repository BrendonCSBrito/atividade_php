...
<html lang="en">
  ...
  <?php
    ...
    if (isset($_GET['excluir'])){
        ...
        $pdo->exec("DELETE FROM tab_clientes WHERE id = $cod_cliente");
  ...
  ?>
    ...
    <?php 
        ...
        foreach($clientes as $cliente){
            echo "<tr>";
            echo '<td align=center><a href="?excluir='. $cliente['id'] . '">(X)</a></td>';
            echo '<td align=center><a href="alterar.php?id='. $cliente['id'] . '">(Alterar)</a></td>';
